...
%George, Edward I., and Robert E. McCulloch. "Variable selection via Gibbs sampling." 
%Journal of the American Statistical Association 88.423 (1993): 881-889.
...
tau_0  = var(y)/(10*T); 
tau_1  = var(y)*max(p^2/(100*T),log(T));
